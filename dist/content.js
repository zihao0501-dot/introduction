...
export const translations = {
  en: {
    ...
    visual: { algorithms: 'algorithms', software: 'software engineering', caption: 'Connecting ideas. Building software.' },
    ...
    education: { label: 'EDUCATION', title: 'A foundation in computer science.', university: 'Monash University', degree: 'Bachelor of Computer Science', specialisation: 'SPECIALISATION', specialisationValue: 'Algorithms and Software', study: 'ADDITIONAL STUDY', studyValue: 'Mathematics · Web Development', result: 'ACADEMIC RESULT', average: 'Distinction Average', wam: 'WAM', badge: 'Undergraduate' },
  ...
  zh: {
    ...
    visual: { algorithms: '算法', software: '软件工程', caption: '连接想法，构建软件。' },
    ...
    education: { label: '教育背景', title: '扎实积累，持续探索。', university: '莫纳什大学', degree: '计算机科学学士', specialisation: '专业方向', specialisationValue: '算法与软件', study: '拓展学习', studyValue: '数学 · Web 开发', result: '学业成绩', average: 'Distinction 平均水平', wam: '加权平均分', badge: '本科在读' },
